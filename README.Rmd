...
This data can be accessed using the following link: https://www.bts.gov/browse-statistical-products-and-data/state-transportation-statistics/state-highway-travel
Usage: This dataset will be used for reporting the number of miles driven each year and the number of licensed drivers per state
